...
#ifndef STM32F4XX_USB_H_
#define STM32F4XX_USB_H_
...
#define USB_OTG_GREGS_BASE (USB_OTG_FS_BASE_ADDR + USB_OTG_CORE_GLOBAL_REGS_OFFSET) // OTG Global Regs
#define USB_OTG_DREGS_BASE (USB_OTG_FS_BASE_ADDR + USB_OTG_DEV_GLOBAL_REG_OFFSET) // OTG Global Regs

#define USB_OTG_FS_GREGS ((USB_OTG_GREGS *) USB_OTG_GREGS_BASE)
#define USB_OTG_FS_DREGS ((USB_OTG_GREGS *) USB_OTG_DREGS_BASE)

#endif /* STM32F4XX_USB_H_ */
